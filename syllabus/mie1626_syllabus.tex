...
\begin{category}{Overview}
    Welcome to \strong{MIE 1626 -- Data Science Methods and Statistical Learning}! The course introduces core
...
\begin{category}{References}
    ...
    \begin{itemize}
        \item Gareth James, Daniela Witten, Trevor Hastie, and Robert Tibshirani.
              \altemph{An Introduction to Statistical Learning with Applications in R}
              (ISLR), 2nd ed. Springer, 2021. Free PDF available at
        ...
        \item Kieran Healy. \altemph{Data Visualization: A Practical Introduction.}
              Princeton University Press, 2026. Free online at \url{https://socviz.co/}
    \end{itemize}
\end{category}
...
\begin{category}{Grading}
    The grading scheme and schedule for the course is as follows.
    \par\medstretch
    ...
    \begin{tabular}{|l|l|l|}
        ...
        Mini-Project 2                                 & 5\%   & May 28 \\ \hline
        Test 1                                         & 10\%  & May 29 \\ \hline
        Mini-Project 3                                 & 5\%   & July 25 \\ \hline
        Mini-Project 4                                 & 5\%   & July 25 \\ \hline
        \specialcell{Preliminary Project Presentation \\ {} + Document}
                                                       & 8\%   & Jun 15 \\ \hline
        Test 2                                         & 30\%  & Wed Aug 12, 2:00pm \\ \hline
        Course Project                                 & 30\%  & Aug 10 \\ \hline
    \end{tabular}
\end{category}
